...
const CaseStudies = () => {
    return (
        <section className="container md:p-8 p-3 mx-auto ">
            ...
            <h1 className="text-4xl sm:text-6xl font-bold text-white pb-2">Projects.</h1>
            <p className="max-w-[1000px] text-base sm:text-xl">These projects demonstrate my expertise with practical examples of some of my work, including brief
