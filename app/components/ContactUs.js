    ...
    return (
        <section id="contact" className='container mx-auto md:p-8 p-3'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-3 md:grid-cols-2 md:gap-4 pt-8'>
                ...
                <div className=''>
                    <h1 className="text-4xl font-bold text-white pb-2">Contacts Me.</h1>
                    <p className="max-w-[1000px] text-xl mb-6">If I can be of assistance, please do not hesitate to contact me <br />
                    ...
                    <div>
                        ...
                        <p className='text-gray-500 dark:text-gray-400 font-semibold pb-2'>+880 1994589676</p>
                    </div>
                    <div>
                ...
                <div className='pb-4 sm:col-span-2 md:col-span-1'>
                    <form action="https://formsubmit.co/dbf74f829bccac24fc1b8f59a048d6e9 " method="POST">
                        ...
                        <div className='mb-2'>
                            <label htmlFor="email" className="block mb-2 text-sm font-medium  text-gray-300">Name</label>
