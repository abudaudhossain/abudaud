...
const ContactUs = () => {
    console.log()
    return (
        <section id="contact" className='container md:p-8 mx-auto'>
            <h1 className="text-6xl font-bold text-white pb-2">Contacts Me.</h1>
...
And I will give you my best.</p>
            <div className='grid grid-cols-1 md:grid-cols-2 md:gap-4 pt-8'>
                <div className=''>
                    <form action="https://formsubmit.co/dbf74f829bccac24fc1b8f59a048d6e9 " method="POST">
                        ...
                        <div className="sm:col-span-2">
                            <label for="message" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Message</label>
